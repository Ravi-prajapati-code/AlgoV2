...
BEAR_SWING_COOLDOWN_DAYS = int(os.getenv("BEAR_SWING_COOLDOWN_DAYS", "7"))   # min days before re-entering same stock after bear-swing exit

QUALITY_STOCKS = []  # no longer used in defensive allocation

GOLD_ETF = "GOLDBEES.NS"
LIQUIDBEES = "LIQUIDBEES.NS"
LIQUIDBEES_ENABLED = os.getenv("LIQUIDBEES_ENABLED", "1") == "1"
# Target weight for LIQUIDBEES when parking idle bear-swing cash (leaves ~5% cash buffer)
