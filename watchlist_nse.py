...
WATCHLIST = [
    ...
    # EICHERMOT removed — slow-momentum stock, consistently enters late in cycle, 4 trades 25% WR
    ...
    # GRINDWELL removed — niche abrasives, RS fades within 2 weeks (LAGGARD_EXIT), structural mismatch
    ...
    # DALBHARAT removed — cement is cyclical/range-bound, not momentum (₹1,850→₹2,400 in 3 yrs),
